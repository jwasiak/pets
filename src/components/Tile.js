...
import { getFavourities } from "../common";
...
const Tile = (props) => {
    ...
    return (
        <div className="box gallery-image" style={style} title="Kliknij aby powiększyć" onClick={showModal}>
            <span
                className={isFavourite ? "icon has-text-danger" : "icon has-text-primary"}
